...
# Словарь фильтров для страницы пользователей
FILTER_BUTTONS = {
    'authors_of_favorite_projects': 'Авторы избранных проектов',
    'authors_of_my_participated_projects': (
        'Авторы проектов, в которых я участвую'
    ),
    'users_who_like_my_projects': (
